...
_TIMEOUT = float(os.environ.get("PKGSENTRY_DOWNLOADS_TIMEOUT", "8"))
_TTL = timedelta(days=int(os.environ.get("PKGSENTRY_DOWNLOADS_TTL_DAYS", "7")))
_CONTACT = os.environ.get("PKGSENTRY_CONTACT_EMAIL", "https://github.com/pkgsentry")


def is_enabled() -> bool:
    return os.environ.get("PKGSENTRY_DOWNLOADS_ENABLED", "1") != "0"


def _ua() -> str:
    return f"pkgsentry-downloads (+{_CONTACT})"
