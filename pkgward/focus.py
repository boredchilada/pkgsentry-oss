...
Mode is governed by ``PKGWARD_FOCUS_EXCLUSIVE``:
...
def focus_exclusive() -> bool:
    """True when PKGWARD_FOCUS_EXCLUSIVE=1 (scan only focus packages)."""
    return os.environ.get("PKGWARD_FOCUS_EXCLUSIVE", "0") == "1"
