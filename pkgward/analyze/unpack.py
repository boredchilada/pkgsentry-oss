...
UPX_BIN = os.environ.get("PKGWARD_UPX_BIN", "upx")
UNPACK_TIMEOUT_SEC = int(os.environ.get("PKGWARD_UNPACK_TIMEOUT", "60"))
...
MAX_UNPACKED_MB = int(os.environ.get("PKGWARD_UNPACK_MAX_MB", "100"))
# Cap how many binaries we try per package (defence against many-packed-files DoS).
MAX_UNPACK_FILES = int(os.environ.get("PKGWARD_UNPACK_MAX_FILES", "25"))
